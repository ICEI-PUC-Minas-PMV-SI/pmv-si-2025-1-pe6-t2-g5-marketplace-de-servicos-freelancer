...

    {
        return (
            <ScrollView className="w-screen bg-purple-500  sm:px-52 sm:py-32">
                <View
                    className="pb-23 relative flex h-full w-full flex-col rounded-sm bg-white p-6 pt-48 iphone-xr:pt-10  sm:p-24">
                    <View
                        className="absolute top-0 flex h-32 w-full items-center justify-end border-b border-gray-200 pb-5 iphone-xr:hidden sm:hidden">
                        <Text className="text-3xl font-light text-purple-500 sm:hidden">Talent Link</Text>
                    </View>

                    <View className="flex flex-col gap-10">
                        <Text
                            className="mb-5 w-3/4 border-l-4 border-purple-500 pl-2 text-2xl font-bold text-purple-500">
                            ...
                            {isDesktop ? (
                                <View className="hidden flex-col md:flex">
                                    ...
                                    <View className="mb-2 flex flex-row">
                                        ...
                                        <View className="flex-1 items-center px-2">
                                            <Text className="text-sm font-semibold text-purple-500">Prazo
                                                Estimado</Text>
                                        </View>
                                        <View className="flex-1 items-center px-2">
                                            ...
                                            <View
                                                ...
                                                <View className="mb-3">
                                                    <View className="mb-3 rounded bg-purple-500 px-3 py-2">
                                                        <Text
                                                            className="text-sm font-medium text-white">{listing.nome}</Text>
                                                    </View>
                                                </View>

                                                <View className="mb-4 flex flex-row flex-wrap">
                                                    <View className="mb-2 w-1/2">
                                                        <Text className="text-xs text-gray-500">Data da
                                                            publicação</Text>
                                                        <Text
                                                            className="text-sm font-medium">{formatUTCtoBR(listing.dataRegistro)}</Text>
                                                    </View>
                                                    <View className="mb-2 w-1/2">
                                                        <Text className="text-xs text-gray-500">Prazo Estimado</Text>
                                                        <Text
                                                            className="text-sm font-medium">{formatUTCtoBR(listing.dataFim)}</Text>
                                                    </View>
                                                    <View className="w-full">
                                                        <Text className="text-xs text-gray-500">Orçamento
                                                            Disponível</Text>
