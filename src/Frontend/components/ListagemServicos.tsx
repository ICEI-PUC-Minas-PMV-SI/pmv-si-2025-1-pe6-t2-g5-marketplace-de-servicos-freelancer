...

  {
    return (
      <ScrollView className="w-screen bg-purple-500  sm:px-52 sm:py-32">
        <View className="pb-23 relative flex h-full w-full flex-col rounded-sm bg-white p-6 pt-48 sm:p-24  iphone-xr:pt-10">
          <View className="absolute top-0 flex h-32 w-full items-center justify-end border-b border-gray-200 pb-5 sm:hidden iphone-xr:hidden">
                    ...
                    filteredProjectList.map((listing: any, index: any) => (
                      <View
                        ...
                        <View className="mb-4 flex flex-row flex-wrap">
                          <View className="mb-2 w-1/2">
                            ...
                            <Text className="text-sm font-medium">
                              {formatUTCtoBR(listing.dataRegistro)}
                            </Text>
                          </View>
                          <View className="mb-2 w-1/2">
                            <Text className="text-xs text-gray-500">Prazo Estimado</Text>
                            <Text className="text-sm font-medium">
                              {formatUTCtoBR(listing.dataFim)}
                            </Text>
                          </View>
                        ...
                        <View className="flex flex-row gap-2">
                          <Pressable
                            className="w-full rounded-md bg-purple-500 px-2 py-2 text-center text-sm font-semibold text-white"
                            onPress={() => assumirProjeto(listing.projetoId)}>
                            <Text className="text-center text-sm font-semibold text-white">
                              Assumir
                            </Text>
