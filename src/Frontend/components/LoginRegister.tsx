import { Text, TextInput, TouchableOpacity, View, ScrollView, ImageBackground, Alert } from 'react-native';
...
export const LoginRegister = () => {
  ...
  async function submitLoginForm(loginForm: any) {
    ...
    try {
      const response = await fetch('https://41d0-2804-d45-8614-e000-40ba-66e1-2497-51c2.ngrok-free.app/api/Auth/login', {
        method: 'POST',
        headers: {
  ...
  return (
    <View className="h-screen w-screen items-center justify-center bg-purple-500 px-4 py-8 sm:px-52 sm:py-32">
      <View className="flex h-full w-full max-w-screen-lg flex-col sm:flex-row rounded-sm bg-purple-400 mx-auto overflow-hidden">
        <ImageBackground
          source={{
          ...
          resizeMode="cover"
          className="relative box-border hidden flex-[2] justify-center items-center gap-8 px-6 py-16 lg:flex lg:flex-col">
          <View className="absolute inset-0 z-10 bg-black/30 p-30" />

          <View className="relative z-20 rounded-lg p-4">
            <Text className="text-5xl mx-auto text-center font-semibold text-white">Bem-vindo(a) ao TalentLink!</Text>
            <Text className="text-center text-base sm:text-sm my-5 mx-auto font-normal text-white max-w-[90%] sm:max-w-md">
        ...
        {registerPage ? (
          <View className="box-border flex items-center justify-center p-4 gap-8 bg-white sm:p-20">
            <ScrollView className='w-full'>
              ...
              <View className="flex w-full flex-col gap-2">
                <Text className="text-base sm:text-lg font-semibold text-purple-500">Me cadastrar como</Text>
              ...
              <View className="flex flex-col gap-2">
               <Text className="text-base sm:text-lg font-semibold text-purple-500">Nome</Text>
              ...
              <View className="flex flex-col gap-2">
                <Text className="text-base sm:text-lg font-semibold text-purple-500">E-mail</Text>
                <View className="w-full flex-row items-center rounded-md border-2 border-purple-500 bg-white px-4 py-0 sm:py-3">
              ...
              <View className="flex flex-col gap-2">
                <Text className="text-base sm:text-lg font-semibold text-purple-500">Telefone</Text>
                <View className="w-full flex-row items-center rounded-md border-2 border-purple-500 bg-white px-4 py-0 sm:py-3">
              ...
              <View className="flex flex-col gap-2">
                <Text className="text-base sm:text-lg font-semibold text-purple-500">CPF</Text>
                <View className="w-full flex-row items-center rounded-md border-2 border-purple-500 bg-white px-4 py-0 sm:py-3">
              ...
              <View className="flex flex-col gap-2">
                <Text className="text-base sm:text-lg font-semibold text-purple-500">Senha</Text>
                <View className="w-full flex-row items-center rounded-md border-2 border-purple-500 bg-white px-4 py-0 sm:py-3">
              ...
              <View className="flex flex-col gap-2">
                <Text className="text-base sm:text-lg font-semibold text-purple-500">Confirmar senha</Text>
                <View className="w-full flex-row items-center rounded-md border-2 border-purple-500 bg-white px-4 py-0 sm:py-3">
              ...
              <Text className="text-sm text-center my-5 mx-auto font-normal text-purple-500 sm:hidden">
          ...
          <View className="box-border flex-[1.4] flex-col items-center justify-center gap-3 bg-white p-4 sm:p-20">
            ...
            <View className="flex flex-col md:flex-row items-center justify-center gap-5 mx-auto">
          <TouchableOpacity onPress={() => setRegisterPage(!registerPage)}>
