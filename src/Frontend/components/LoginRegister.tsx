...
export const LoginRegister = () => {
    ...
    return (
        <View className="h-screen w-screen items-center justify-center bg-purple-500 px-4 py-8 sm:px-52 sm:py-32">
            <View
                className="mx-auto flex h-full w-full max-w-screen-lg flex-col overflow-hidden rounded-sm bg-purple-400 sm:flex-row">
                <ImageBackground
                    source={{
                    ...
                    <View className="relative z-20 rounded-lg p-4">
                        ...
                        <Text
                            className="mx-auto my-5 max-w-[90%] text-center text-base font-normal text-white sm:max-w-md sm:text-sm">
                ...
                {registerPage ? (
                    <View className="box-border flex items-center justify-center gap-8 bg-white p-4 sm:p-20">
                        <ScrollView className="w-full">
                            <View
                                className=" flex h-5 w-full items-center justify-end border-b border-purple-500 pb-5 sm:hidden">
                            ...
                            <View className="flex flex-col gap-2">
                                ...
                                <View
                                    className="w-full flex-row items-center rounded-md border-2 border-purple-500 bg-white px-4 py-0 sm:py-3">
                    ...
                    <View
                        className="box-border flex-[1.4] flex-col items-center justify-center gap-3 bg-white p-4 sm:p-20">
                        <Text
                            className="mb-5 w-3/4 border-l-4 border-purple-500 pl-2 text-2xl font-bold text-purple-500">
                            USER LOGIN
                        </Text>
