...
export const SolicitarNovoServico = ({ path }: { path: string }) => {
  ...
  return (
    <ScrollView className="w-screen bg-purple-500 sm:px-52 sm:py-32">
      <View className="pb-23 relative flex h-full w-full flex-col rounded-sm bg-white p-10 pt-48 sm:p-24 iphone-xr:pt-10">
        <View className="absolute top-0 flex h-32 w-screen items-center justify-end border-b border-gray-200 pb-5 sm:hidden iphone-xr:hidden">
