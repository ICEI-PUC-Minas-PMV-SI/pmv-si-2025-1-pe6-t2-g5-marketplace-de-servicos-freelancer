...
export const SolicitarNovoServico = ({path}: { path: string }) => {
    ...
    return (
        <ScrollView className="w-screen bg-purple-500 sm:px-52 sm:py-32">
            <View
                className="pb-23 relative flex h-full w-full flex-col rounded-sm bg-white p-10 pt-48 iphone-xr:pt-10 sm:p-24">
                <View
                    className="absolute top-0 flex h-32 w-screen items-center justify-end border-b border-gray-200 pb-5 iphone-xr:hidden sm:hidden">
                ...
                <View className="flex flex-col gap-6 space-y-4">
                    <View className="flex flex-col iphone-xr:gap-6">
                        <View className="flex w-full flex-row items-center iphone-xr:flex-col iphone-xr:items-start">
                            <Text
                                className="mb-5 w-3/4 border-l-4 border-purple-500 pl-2 text-2xl font-bold text-purple-500 iphone-xr:w-full">
