    ...
    return (
        <ScrollView className="w-screen bg-purple-500 sm:px-52 sm:py-32">
            <View className="pb-23 relative flex h-full w-full flex-col rounded-sm bg-white p-6 sm:p-24">
                {freelancerDetails && (
                    <View
                        className="absolute left-0 top-0 z-50 h-full w-full items-center justify-center bg-black/40 px-4 py-10">
                            ...
                            <View className="mb-6">
                                <View className="flex flex-col gap-6">
                                    <View className="flex flex-col items-start gap-4">
                                        ...
                                        <View
                                            className="w-full flex-row items-center rounded-md border-2 border-purple-500 bg-white px-4 py-3">
                                        ...
                                        <View className="flex flex-row flex-wrap gap-3">
                                            {categorias.map((option) => (
                                                <TouchableOpacity
                                                    ...
                                                    <View
                                                        className="mr-2 h-5 w-5 items-center justify-center rounded-full border-2 border-purple-500">
                                                        {form.escopo === option && (
                                                            <View className="h-2.5 w-2.5 rounded-full bg-purple-500"/>
                                                        )}
                                                    </View>
                                                    <Text
                                                        className="text-base capitalize text-purple-500">{option}</Text>
                                                </TouchableOpacity>
                                            ))}
                                        </View>
                                    </View>
                ...
                <View
                    className="absolute top-0 flex hidden h-20 w-full items-center justify-end border-b border-gray-200 pb-5">
                                        ...
                                        <View
                                            ...
                                            <View className="mb-2 flex flex-row justify-between">
                                                ...
                                                <View className="w-1/2 pl-2">
                                                    ...
                                                    <Text
                                                        className="text-sm font-medium">{formatDate(listing.dataFim)}</Text>
                                                </View>
                                            </View>
                                            ...
                                            <View className="mt-3 flex flex-row items-center justify-between gap-2 ">
                                                {listing.status === 1 ? (
                                                    <View
                                                        className="flex w-1/2 flex-row items-center justify-center py-1 rounded-md space-x-2 bg-[#6b7280]">
                                                        <Pressable className="flex cursor-default items-center">
                                                            <Entypo
                                                                name="edit"
                                                                size={20}
                                                    ...
                                                    <View
                                                        className="flex w-1/2 flex-row items-center justify-center py-1 rounded-md space-x-2 bg-[#EFD64A]">
                                                        <Pressable
                                                            className="flex items-center"
                                                            onPress={() => {
                                                                setModalEditProject(true);
                                                ...
                                                {listing.status === 1 ? (
                                                    ...
                                                    <View
                                                        className="flex w-1/2 flex-row items-center justify-center py-1 rounded-md space-x-2 bg-[#ef4444]">
                                                        <Pressable
                                                            className="flex items-center"
                                                            onPress={() => {
                                                                setModalDeleteProject(true);
